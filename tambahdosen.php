...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tb_dosen (nama, nik, email, jenis_kelamin, tanggal_lahir, alamat, foto)
            VALUES ('$nama', '$nik', '$email', '$jenis_kelamin', '$tanggal_lahir', '$alamat', '$foto')";
