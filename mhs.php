                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($row['foto'])) { ?>
                                <img src="./uploads/<?php echo $row['foto']; ?>" alt="Foto Mahasiswa" width="50">
                            <?php } else { ?>
                                -
                            <?php } ?>
                        </td>
                        <td>
                            <a href="viewmhs.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm">Lihat</a>
                            <a href="editmhs.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="hapusmhs.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
                        </td>
                    </tr>
                <?php
                    $no++;
